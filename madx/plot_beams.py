...
parser = argparse.ArgumentParser(
    description='This is a script to plot data from tfs files.')
parser.add_argument('-t_b1', '--twiss_b1',
                    help='Twiss Beam 1 file', required=True)
parser.add_argument('-t_b2', '--twiss_b2',
                    help='Twiss Beam 2 file', required=True)
parser.add_argument('-s_b1', '--survey_b1',
                    help='Survey Beam 1 file', required=False)
parser.add_argument('-s_b2', '--survey_b2',
                    help='Survey Beam 2 file', required=False)
parser.add_argument('-p', '--plot', help='Plot type', required=True)
parser.add_argument('-ip', '--plot_ip',
                    help='Plotting around a certain IP', required=True)
parser.add_argument('-lim', '--limit',
                    help='Horizontal limit of the plot', required=True)
parser.add_argument('-arg1', '--arg_1',
                    help='Horizontal argument of the plot', required=False)
parser.add_argument('-arg2', '--arg_2',
                    help='Vertical argument of the plot', required=False)
parser.add_argument('-arg3', '--arg_3',
                    help='Vertical argument of the plot', required=False)
...
twiss_b1 = get_madx_columns(args.twiss_b1, 'S', 'X',
                            'Y', 'BETX', 'BETY', 'NAME', 'L')
twiss_b2 = get_madx_columns(args.twiss_b2, 'S', 'X',
                            'Y', 'BETX', 'BETY', 'NAME', 'L')
...
if args.plot == "ORBIT":  # orbit plots ##
    ...
    if args.survey_b1 is None and args.survey_b2 is None:  # no survey files
        ...
        ## beam 1 data ##
        s_b1_y, y_b1, one_sigma_y_b1, m_one_sigma_y_b1, five_sigma_y_b1, m_five_sigma_y_b1 = plot_twiss_beams(
            twiss_b1['S'], twiss_b1['Y'], 7e12, 2.5e-6, twiss_b1['BETY'], args.plot_ip, args.limit)
        s_b1_x, x_b1, one_sigma_x_b1, m_one_sigma_x_b1, five_sigma_x_b1, m_five_sigma_x_b1 = plot_twiss_beams(
            twiss_b1['S'], twiss_b1['X'], 7e12, 2.5e-6, twiss_b1['BETX'], args.plot_ip, args.limit)

        ## beam 2 data ##
        s_b2_y, y_b2, one_sigma_y_b2, m_one_sigma_y_b2, five_sigma_y_b2, m_five_sigma_y_b2 = plot_twiss_beams(
            twiss_b2['S'], twiss_b2['Y'], 7e12, 2.5e-6, twiss_b2['BETY'], args.plot_ip, args.limit)
        s_b2_x, x_b2, one_sigma_x_b2, m_one_sigma_x_b2, five_sigma_x_b2, m_five_sigma_x_b2 = plot_twiss_beams(
            twiss_b2['S'], twiss_b2['X'], 7e12, 2.5e-6, twiss_b2['BETX'], args.plot_ip, args.limit)
    ...
    ax1.fill_between(s_b1_y, one_sigma_y_b1,
                     m_one_sigma_y_b1, facecolor='blue')
    ax1.plot(s_b1_y, m_five_sigma_y_b1, color='blue', alpha=0.3)
    ax1.fill_between(s_b1_y, one_sigma_y_b1, five_sigma_y_b1,
                     facecolor='blue', alpha=0.3)
    ax1.fill_between(s_b1_y, m_five_sigma_y_b1,
                     m_one_sigma_y_b1, facecolor='blue', alpha=0.3)
    ...
    ax1.fill_between(s_b2_y, one_sigma_y_b2, five_sigma_y_b2,
                     facecolor='red', alpha=0.3)
    ax1.fill_between(s_b2_y, m_five_sigma_y_b2,
                     m_one_sigma_y_b2, facecolor='red', alpha=0.3)
    ...
    plot_elem('red', height, bottom, name, s, l,
              'MQXFA', 'MQXFB')  # Triplet: Q1, Q3, Q2
    plot_elem('blue', height, bottom, name, s, l, 'MBX', 'MBRC',
              'MBRS', 'MBRB', 'MB')  # Dipoles: D1, D2, D3, D4
    plot_elem('orange', height, bottom, name, s, l, 'TAXS',
              'TAXN')  # Passive protectors: TAS, TAN
    plot_elem('black', height, bottom, name, s,
              l, 'TCT')  # Tertiary collimators
    ...
    ax2.fill_between(s_b1_x, one_sigma_x_b1,
                     m_one_sigma_x_b1, facecolor='blue')
    ax2.fill_between(s_b1_x, one_sigma_x_b1, five_sigma_x_b1,
                     facecolor='blue', alpha=0.3)
    ax2.fill_between(s_b1_x, m_five_sigma_x_b1,
                     m_one_sigma_x_b1, facecolor='blue', alpha=0.3)
    ...
    ax2.fill_between(s_b2_x, one_sigma_x_b2, five_sigma_x_b2,
                     facecolor='red', alpha=0.3)
    ax2.fill_between(s_b2_x, m_five_sigma_x_b2,
                     m_one_sigma_x_b2, facecolor='red', alpha=0.3)
    ...
    if args.arg_1 is not None and args.arg_2 is not None and args.arg_3 is None:
        ...
        x, y = plot_twiss(twiss_b1[args.arg_1], twiss_b1[
                          args.arg_2],  args.plot_ip, args.limit)
        ...
        plt.subplots_adjust(left=0.15, bottom=0.15, right=0.94, top=0.90)
        plt.savefig(args.arg_1 + '_' + args.arg_2 + '_' +
                    'IP' + args.plot_ip + '.png', dpi=DPI)
        plt.clf()
        ...
        twiss_b1 = get_madx_columns(
            args.twiss_b1,  args.arg_1,  args.arg_2, args.arg_3)
        x, y1 = plot_twiss(twiss_b1[args.arg_1], twiss_b1[
                           args.arg_2],  args.plot_ip, args.limit)
        x_temp, y2 = plot_twiss(twiss_b1[args.arg_1], twiss_b1[
                                args.arg_3],  args.plot_ip, args.limit)
        ax3 = fig.add_subplot(111)
        ...
        plt.subplots_adjust(left=0.15, bottom=0.15, right=0.94, top=0.90)
        plt.savefig(args.arg_1 + '_' + args.arg_2 + '_' +
                    args.arg_3 + '_' + 'IP' + args.plot_ip + '.png', dpi=DPI)
        plt.clf()
    else:
        print " "
