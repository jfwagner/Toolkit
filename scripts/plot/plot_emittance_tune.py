...
for turn in range(1, total_turns + 1):
    ...
    det_x[turn - 1] = multiply(term_1_x[turn - 1], term_4_x[turn - 1]) - \
        multiply(term_3_x[turn - 1], term_2_x[turn - 1])
    ...
    det_y[turn - 1] = multiply(term_1_y[turn - 1], term_4_y[turn - 1]) - \
        multiply(term_3_y[turn - 1], term_2_y[turn - 1])
