...
plt.plot(x1c - 5, y1c, '-o', linewidth=0.5, markersize=3, label='Case 1C', color='#002db3')
plt.plot(x1d - 5, y1d, '-o', linewidth=0.5, markersize=3, label='Case 1D', color='#32bbcd')
ax1.set_xlim([0, 10])
...
plt.plot(x2c - 5, y2c, '-o', linewidth=0.5, markersize=3, label='Case 2C', color='#456300')
plt.plot(x2d - 5, y2d, '-o', linewidth=0.5, markersize=3, label='Case 2D', color='#9ccd32')
...
ax3.annotate('Beam dump', xy=(4.4, 0.7), xytext=(4.4, 0.7), rotation='vertical', size='4', verticalalignment='center')
plt.plot(x3c - 5, y3c, '-o', linewidth=0.5, markersize=3, label='Case 3C', color='#694100')
plt.plot(x3d - 5, y3d, '-o', linewidth=0.5, markersize=3, label='Case 3D', color='#e19100')
...
# plt.scatter(5, 0.1521, marker=(5,1), color='yellow', linewidth=0.5, edgecolor='black')
plt.axvline(x=5, linewidth=0.7, color='black')
ax4.annotate('Beam dump', xy=(4.4, 7), xytext=(4.4, 7), rotation='vertical', size='4', verticalalignment='center')
plt.plot(x4c - 5, y4c, '-o', linewidth=0.5, markersize=3, label='Case 4C', color='#500914')
plt.plot(x4d - 5, y4d, '-o', linewidth=0.5, markersize=3, label='Case 4D', color='#ea1640')
plt.plot(5, 0.1521, 'y*')
